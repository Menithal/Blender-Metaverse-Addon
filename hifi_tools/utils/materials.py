...
# TODO: Needs fixing, as there is an entirely new materials system.
def get_images_from(meshes):
    print("TODO: IMPLEMENT ME materials.get_images_from")
    return []
   #images = []
   # for mesh in meshes:
   #     if(mesh.type == "MESH"):
...
def cleanup_alpha(materials):
    print("TODO: IMPLEMENT ME materials.cleanup_alpha")
...
def cleanup_unused(images):
    print("TODO: IMPLEMENT ME materials.cleanup_unused")
    # for image in images:
...
def convert_to_png(images):
    print("TODO: IMPLEMENT ME materials.convert_to_png")
...
def pack_images(images):
    print("TODO: IMPLEMENT ME materials.pack_images")
...
def unpack_images(images):
    print("TODO: IMPLEMENT ME materials.unpack_images")
    #print("#########")
...
def convert_image_to_mask(image, threshold):
    print("TODO: IMPLEMENT ME materials.convert_image_to_mask")
...
def convert_images_to_mask(images, threshold=0.3):
    print("TODO: IMPLEMENT ME materials.convert_images_to_mask")
    #for image in images:
    #    convert_image_to_mask(image, threshold)


def make_material_shadeless(material):
    print("TODO: IMPLEMENT ME materials.make_material_shadeless")
...
def remove_materials_metallic(materials):
    print("TODO: IMPLEMENT ME materials.remove_materials_metallic")
    #for material in materials:
    #    material.specular_color = (0, 0, 0)


def make_material_shaded(material):
    print("TODO: IMPLEMENT ME materials.make_material_shaded")
    #if material is not None:
...
def make_materials_fullbright(materials):
    print("TODO: IMPLEMENT ME materials.make_materials_fullbright")
    #for material in materials:
    #    for texture_slot in material.texture_slots:
...
def get_textures_for_slot(texture_slots, texture_type="ALL"):
    print("TODO: IMPLEMENT ME materials.get_textures_for_slot")
    texture_list = []
...
def clean_textures(material):
    print("TODO: IMPLEMENT ME materials.clean_textures")
    textures = []
...
def merge_textures(materials_slots, unique_textures=None):
    print("TODO: IMPLEMENT ME materials.merge_textures")
...
def flip_material_specular(material):
    print("TODO: IMPLEMENT ME materials.flip_material_specular")
    #material.specular_color = (0, 0, 0)
